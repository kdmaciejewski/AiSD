...
public interface IList<E> extends Iterable<E> {
    ...
    boolean add(int index, E element); // dodanie elementu na podanej pozycji //zmienione na boolean z void
    void clear(); // skasowanie wszystkich elementów
    boolean contains(E e); // czy lista zawiera podany element (equals())
    ...
    boolean remove(E e); // usuwa element (equals())
